    ...
    <div className={sectionClassName}>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border-b border-gray-200 pb-4">
          <h3 className="text-md font-semibold text-sky-800 mb-4">Lens Specifications</h3>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="70"
                />
                <span className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-400 text-xs">mm</span>
              </div>
            </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-md font-semibold text-sky-800">Prescription Details</h3>
            <button
              type="button"
        ...
        <div className="flex justify-end space-x-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-5 py-2 bg-sky-600 text-white font-medium rounded-lg hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 disabled:opacity-50 transition-colors shadow-sm"
          >
            {loading ? (
