    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        ...
        <div className="flex flex-wrap items-center justify-between">
          <div className="flex items-center">
            ...
            <input
              ...
              className="rounded-md border-gray-300 border border-gray-400 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm"
            />
          </div>
          ...
          <div className="flex gap-2 mt-2 sm:mt-0">
            <button 
              onClick={handlePrint}
              className="flex items-center px-3 py-1 bg-gray-100 text-gray-800 rounded border border-gray-300 text-sm hover:bg-gray-200"
            >
            ...
            <button 
              ...
              className="flex items-center px-3 py-1 bg-green-100 text-green-800 rounded border border-green-300 text-sm hover:bg-green-200"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-12 bg-gray-50">
          ...
          <p className="text-gray-500">Calculating balances as of {formatDisplayDate(balanceAsOfDate)}...</p>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200 border-collapse">
            <thead className="bg-gray-50">
              <tr className="border-b border-gray-300">
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">Party Name</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider w-[150px]">Balance Due</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {balanceSummary.map((summary) => (
                ...
                >
                  <td className="px-4 py-3 text-sm text-left text-gray-900 border-r border-gray-200">
                    {summary.name}
                  </td>
