  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center py-6">
        ...
        <span className="ml-2 text-sm text-gray-500 dark:text-gray-400">Loading contact lenses...</span>
      </div>
    );
  }
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-xs sm:text-sm text-yellow-700 dark:text-yellow-200">
              No contact lenses in inventory yet. Add your first contact lens to get started!
            </p>
          </div>
        </div>
      </div>
